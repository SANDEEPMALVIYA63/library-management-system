...
CREATE TABLE "user" (
    ...
    "role" "UserType" NOT NULL DEFAULT 'LIBRARIAN',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "rental_book_id_idx" ON "rental"("book_id");

-- CreateIndex
CREATE INDEX "rental_status_idx" ON "rental"("status");

-- CreateIndex
CREATE UNIQUE INDEX "registry_rental_id_key" ON "registry"("rental_id");

-- CreateIndex
CREATE INDEX "registry_book_id_idx" ON "registry"("book_id");

-- CreateIndex
CREATE INDEX "registry_user_id_idx" ON "registry"("user_id");
...
-- AddForeignKey
ALTER TABLE "rental" ADD CONSTRAINT "rental_issued_by_user_id_fkey" FOREIGN KEY ("issued_by_user_id") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "registry" ADD CONSTRAINT "registry_book_id_fkey" FOREIGN KEY ("book_id") REFERENCES "book"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "registry" ADD CONSTRAINT "registry_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "registry" ADD CONSTRAINT "registry_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "rental"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
